...
public class FormDataListWidget extends GenericWidget {
  ...
  public WidgetContext post(WidgetContext context) {
    // CSV export (issue #483) requires the page's own role list -- checked here rather than at the
    // page/servlet level because this command streams a file response directly, bypassing the normal
    // JSP render path where a role check would otherwise happen.
